...
def install_pointnet2_ops():
    # https://github.com/ZrrSkywalker/Point-M2AE/tree/main?tab=readme-ov-file#installation
    git_command = "git+https://github.com/erikwijmans/Pointnet2_PyTorch.git#egg=pointnet2_ops&subdirectory=pointnet2_ops_lib"
    try:
        subprocess.check_call([sys.executable, "-m", "pip", "install", git_command])
        print("pointnet2_ops has been successfully installed.")
    except subprocess.CalledProcessError as e:
        print(f"Failed to install pointnet2_ops. Error: {e}")

try:
    from pointnet2_ops import pointnet2_utils
    print("pointnet2_ops is already installed.")
except ImportError:
    print("pointnet2_ops not found. Installing now...")
    install_pointnet2_ops()
    # Attempt to import again after installation
    try:
        from pointnet2_ops import pointnet2_utils
        print("pointnet2_ops successfully imported after installation.")
    except ImportError:
